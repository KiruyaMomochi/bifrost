...
1. Navigate to **Model Providers** -> **Configurations** -> **vLLM**.
...
6. Set **Models** to `meta-llama/Llama-3.2-1B-Instruct` or the specific model allowlist you want this key to serve.
